...
public class wsAvion {
    ...
    @WebMethod(operationName = "consultarAviones")
    public List<Avion> consultarAviones(@WebParam(name = "descripcion") String descripcion) {
        return ejbRef.consultarAviones(descripcion);
    }
